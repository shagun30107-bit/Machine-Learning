...
- Gradient boosting (XGBoost/LightGBM) for potentially stronger performance
- SMOTE for synthetic minority oversampling, as an alternative/complement to class weighting
- Further feature engineering (e.g., interaction terms between tenure and contract type)
